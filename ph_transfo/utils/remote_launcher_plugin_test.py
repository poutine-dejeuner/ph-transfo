...
# Use monkeypatch.setattr(ph_transfo.utils.remote_launcher_plugin, ..., that_mock)
...
import ph_transfo.utils.remote_launcher_plugin
from ph_transfo.main import PROJECT_NAME, main
from ph_transfo.main_test import CONFIG_DIR
from ph_transfo.utils import remote_launcher_plugin
from ph_transfo.utils.env_vars import SLURM_JOB_ID
from ph_transfo.utils.remote_launcher_plugin import RemoteSlurmLauncher
from ph_transfo.utils.testutils import IN_GITHUB_CI, IN_SELF_HOSTED_GITHUB_CI
...
def test_run_remote_job(argv: list[str], monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr(
        ph_transfo.utils.remote_launcher_plugin, RemoteSlurmLauncher.__name__, launcher_mock
    )

    monkeypatch.setattr(sys, "argv", ["ph_transfo/main.py"] + argv)

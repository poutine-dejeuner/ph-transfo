...
from ph_transfo.utils.env_vars import NETWORK_DATASETS_DIR, SLURM_JOB_ID
from ph_transfo.utils.hydra_utils import get_outer_class
...
def get_target_of_config(
    ...
    if _cs is None:
        from ph_transfo.configs import cs as _cs

...
def setup_logging(log_level: str, global_log_level: str = "WARNING") -> None:
    from ph_transfo.main import PROJECT_NAME
    ...
    ph_transfo_logger = logging.getLogger(PROJECT_NAME)
    ph_transfo_logger.setLevel(log_level.upper())
